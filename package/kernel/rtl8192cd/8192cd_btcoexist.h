 ...
 *
 ******************************************************************************/
#ifndef __8192cd_BTCOEX_H__
#define __8192cd_BTCOEX_H__
...
#define IS_BT_COEXIST_AVALIABLE(adapter) (adapter->pshare->bt_coex_comm_data.EEPROMBluetoothCoexist)
...
void rtw_btcoex_SetManualControl(BT_COEX_HAL_ADAPTER *padapter, u8 bmanual);
...
u8 rtw_btcoex_btinfo_cmd(BT_COEX_HAL_ADAPTER *padapter, u8 *pbuf, u16 buf_len);
void rtw_btcoex_parse_hci_cmd(BT_COEX_HAL_ADAPTER *padapter, u8 *cmd, u16 len);
...
extern void rtw_btcoex_LPS_Enter(BT_COEX_HAL_ADAPTER *padapter);
