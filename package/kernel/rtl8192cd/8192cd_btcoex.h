...
void rtw_btcoex_Initialize(RTL8192CD_PRIV *priv);
void rtw_btcoex_PowerOnSetting(RTL8192CD_PRIV *priv);
void rtw_btcoex_PreLoadFirmware(RTL8192CD_PRIV *priv);
void rtw_btcoex_HAL_Initialize(RTL8192CD_PRIV *priv, u8 bWifiOnly);
void rtw_btcoex_IpsNotify(RTL8192CD_PRIV *priv, u8 type);
void rtw_btcoex_LpsNotify(RTL8192CD_PRIV *priv, u8 type);
void rtw_btcoex_ScanNotify(RTL8192CD_PRIV *priv, u8 type);
void rtw_btcoex_ConnectNotify(RTL8192CD_PRIV *priv, u8 action);
void rtw_btcoex_MediaStatusNotify(RTL8192CD_PRIV *priv, u8 mediaStatus);
void rtw_btcoex_SpecialPacketNotify(RTL8192CD_PRIV *priv, u8 pktType);
void rtw_btcoex_IQKNotify(RTL8192CD_PRIV *priv, u8 state);
void rtw_btcoex_BtInfoNotify(RTL8192CD_PRIV *priv, u8 length, u8 *tmpBuf);
void rtw_btcoex_SuspendNotify(RTL8192CD_PRIV *priv, u8 state);
void rtw_btcoex_HaltNotify(RTL8192CD_PRIV *priv);
void rtw_btcoex_SwitchBtTRxMask(RTL8192CD_PRIV *priv);
void rtw_btcoex_Switch(RTL8192CD_PRIV *priv, u8 enable);
u8 rtw_btcoex_IsBtDisabled(RTL8192CD_PRIV *priv);
void rtw_btcoex_Handler(RTL8192CD_PRIV *priv);
s32 rtw_btcoex_IsBTCoexRejectAMPDU(RTL8192CD_PRIV *priv);
s32 rtw_btcoex_IsBTCoexCtrlAMPDUSize(RTL8192CD_PRIV *priv);
u32 rtw_btcoex_GetAMPDUSize(RTL8192CD_PRIV *priv);
void rtw_btcoex_SetManualControl(RTL8192CD_PRIV *priv, u8 bmanual);
u8 rtw_btcoex_1Ant(RTL8192CD_PRIV *priv);
u8 rtw_btcoex_IsBtControlLps(RTL8192CD_PRIV *priv);
u8 rtw_btcoex_IsLpsOn(RTL8192CD_PRIV *priv);
u8 rtw_btcoex_RpwmVal(RTL8192CD_PRIV *priv);
u8 rtw_btcoex_LpsVal(RTL8192CD_PRIV *priv);
void rtw_btcoex_SetBTCoexist(RTL8192CD_PRIV *priv, u8 bBtExist);
void rtw_btcoex_SetChipType(RTL8192CD_PRIV *priv, u8 chipType);
void rtw_btcoex_SetPGAntNum(RTL8192CD_PRIV *priv, u8 antNum);
u8 rtw_btcoex_GetPGAntNum(RTL8192CD_PRIV *priv);
void rtw_btcoex_SetSingleAntPath(RTL8192CD_PRIV *priv, u8 singleAntPath);
u32 rtw_btcoex_GetRaMask(RTL8192CD_PRIV *priv);
void rtw_btcoex_RecordPwrMode(RTL8192CD_PRIV *priv, u8 *pCmdBuf, u8 cmdLen);
void rtw_btcoex_DisplayBtCoexInfo(RTL8192CD_PRIV *priv, u8 *pbuf, u32 bufsize);
void rtw_btcoex_SetDBG(RTL8192CD_PRIV *priv, u32 *pDbgModule);
u32 rtw_btcoex_GetDBG(RTL8192CD_PRIV *priv, u8 *pStrBuf, u32 bufSize);
u8 rtw_btcoex_IncreaseScanDeviceNum(RTL8192CD_PRIV *priv);
u8 rtw_btcoex_IsBtLinkExist(RTL8192CD_PRIV *priv);
void rtw_btcoex_BTOffOnNotify(RTL8192CD_PRIV *priv, u8 bBTON);
#ifdef CONFIG_BT_COEXIST_SOCKET_TRX
void rtw_btcoex_SetBtPatchVersion(RTL8192CD_PRIV *priv,u16 btHciVer, u16 btPatchVer);
void rtw_btcoex_SetHciVersion(RTL8192CD_PRIV *priv, u16 hciVersion);
void rtw_btcoex_StackUpdateProfileInfo(void);
void rtw_btcoex_PTAOffOnNotify(RTL8192CD_PRIV *priv, u8 bBTON);
void rtw_btcoex_init_socket(RTL8192CD_PRIV *priv);
void rtw_btcoex_close_socket(RTL8192CD_PRIV *priv);
void rtw_btcoex_dump_tx_msg(u8 *tx_msg, u8 len, u8 *msg_name);
u8 rtw_btcoex_sendmsgbysocket(RTL8192CD_PRIV *priv, u8 *msg, u8 msg_size, bool force);
u8 rtw_btcoex_create_kernel_socket(RTL8192CD_PRIV *priv);
void rtw_btcoex_close_kernel_socket(RTL8192CD_PRIV *priv);
void rtw_btcoex_recvmsgbysocket(void *data);
u16 rtw_btcoex_parse_recv_data(u8 *msg, u8 msg_size);
u8 rtw_btcoex_btinfo_cmd(RTL8192CD_PRIV *priv, u8 *pbuf, u16 length);
void rtw_btcoex_parse_hci_cmd(RTL8192CD_PRIV *priv, u8 *cmd, u16 len);
void rtw_btcoex_SendEventExtBtCoexControl(RTL8192CD_PRIV *priv, u8 bNeedDbgRsp, u8 dataLen, void *pData);
void rtw_btcoex_SendEventExtBtInfoControl(RTL8192CD_PRIV *priv, u8 dataLen, void *pData);
void rtw_btcoex_SendScanNotify(RTL8192CD_PRIV *priv, u8 scanType);
#define BT_SendEventExtBtCoexControl(priv, bNeedDbgRsp, dataLen, pData) rtw_btcoex_SendEventExtBtCoexControl(priv, bNeedDbgRsp, dataLen, pData)
#define BT_SendEventExtBtInfoControl(priv, dataLen, pData) rtw_btcoex_SendEventExtBtInfoControl(priv, dataLen, pData)
#endif //CONFIG_BT_COEXIST_SOCKET_TRX

// ==================================================
// Below Functions are called by BT-Coex
// ==================================================
void rtw_btcoex_rx_ampdu_apply(RTL8192CD_PRIV *priv);
//void rtw_btcoex_LPS_Enter(RTL8192CD_PRIV *priv);
//void rtw_btcoex_LPS_Leave(RTL8192CD_PRIV *priv);
