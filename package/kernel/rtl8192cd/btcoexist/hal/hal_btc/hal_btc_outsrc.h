#ifndef	__HAL_BTC_OUT_SRC_H__
#define __HAL_BTC_OUT_SRC_H__
...
#define		BTC_SPRINTF			printk
#define		BTC_TRACE(_MSG_) 		RT_TRACE(COMP_COEX, DBG_LOUD, (_MSG_))
#define		BT_PrintData(adapter, _MSG_, len, data)	printk("%s: col_h2c_len=%d, H2C_Parameter=%d",(_MSG_), data, len)
