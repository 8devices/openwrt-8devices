...
)
{
	...
	u4Byte     ArrayLen    = sizeof(Array_TC_8821C_MAC_REG)/sizeof(u4Byte);
	pu4Byte    Array       = Array_TC_8821C_MAC_REG;
	
	u4Byte	v1 = 0, v2 = 0, pre_v1 = 0, pre_v2 = 0;

	ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> ODM_ReadAndConfig_TC_8821C_MAC_REG\n"));
	...
	while ((i + 1) < ArrayLen) {
		...
		if (v1 & (BIT31 | BIT30)) {/*positive & negative condition*/
			...
			if (bMatched)
				odm_ConfigMAC_8821C(pDM_Odm, v1, (u1Byte)v2);
		}
		i = i + 2;
	}
}
...
u4Byte
ODM_GetVersion_TC_8821C_MAC_REG(void)
{
	   return 9;
}
