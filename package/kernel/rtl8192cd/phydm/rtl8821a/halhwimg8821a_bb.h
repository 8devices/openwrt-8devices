...
void
ODM_ReadAndConfig_MP_8821A_PHY_REG_PG_DNI_JP(/* TC: Test Chip, MP: MP Chip*/
	IN   PDM_ODM_T  pDM_Odm
);
u4Byte ODM_GetVersion_MP_8821A_PHY_REG_PG_DNI_JP(void);
...
void
ODM_ReadAndConfig_MP_8821A_PHY_REG_PG_DNI_US(/* TC: Test Chip, MP: MP Chip*/
	IN   PDM_ODM_T  pDM_Odm
);
u4Byte ODM_GetVersion_MP_8821A_PHY_REG_PG_DNI_US(void);
