...
#if (DM_ODM_SUPPORT_TYPE & ODM_AP) 
		u1Byte tmp_5d1 = ODM_Read1Byte(pDM_Odm, 0x5d1);
		if(pDM_Odm->priv->pshare->rf_ft_var.txpause_iqk){	
			ODM_Write1Byte(pDM_Odm, 0x5d1, 0xff);
		}
#endif
...
#if (DM_ODM_SUPPORT_TYPE & ODM_AP) 
	if(pDM_Odm->priv->pshare->rf_ft_var.txpause_iqk){	
		ODM_Write1Byte(pDM_Odm, 0x5d1, tmp_5d1);
	}
#endif
