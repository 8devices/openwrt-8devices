...
#define ODM_N_ANTDIV_SUPPORT		(ODM_RTL8188E|ODM_RTL8192E|ODM_RTL8723B|ODM_RTL8188F|ODM_RTL8723D|ODM_RTL8197F)
...
#define ODM_EVM_ENHANCE_ANTDIV_SUPPORT_IC	(ODM_RTL8192E|ODM_RTL8197F)
...
typedef struct _FAST_ANTENNA_TRAINNING_
{
	...
	/*For 2SS RX phy rate*/
	u4Byte	MainAntEVM_2ss_Sum[ODM_ASSOCIATE_ENTRY_NUM][2]; 	/*2SS with A1+B*/
