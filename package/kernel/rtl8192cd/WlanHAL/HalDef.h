...
typedef enum _HAL_INT_TYPE
{
	...
	HAL_INT_TYPE_GTIMER3,           // Gtimer 3. TCP_ACK_ACC
...
typedef void
(*NicSetATM_ReportHandler)(
    IN HAL_PADAPTER  Adapter,
    u1Byte atm_en, 
    u1Byte range1_en,    u1Byte range2_en,    u1Byte range3_en, u1Byte range4_en,
...
//    NicGetShortCutTxDescriptorHandler       GetShortCutTxDescHandler;
    ...
    NicSetATM_ReportHandler                 SetATM_ReportHandler;
...
// RTL8812 Series
//
#define rtw_get_hw_type(adapter) (adapter)
