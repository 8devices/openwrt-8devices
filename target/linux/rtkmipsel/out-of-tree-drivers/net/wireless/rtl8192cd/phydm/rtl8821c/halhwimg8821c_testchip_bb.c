...
)
{
	...
	u4Byte     ArrayLen    = sizeof(Array_TC_8821C_AGC_TAB)/sizeof(u4Byte);
	pu4Byte    Array       = Array_TC_8821C_AGC_TAB;
	
	u4Byte	v1 = 0, v2 = 0, pre_v1 = 0, pre_v2 = 0;

	ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> ODM_ReadAndConfig_TC_8821C_AGC_TAB\n"));
	...
	while ((i + 1) < ArrayLen) {
		...
		if (v1 & (BIT31 | BIT30)) {/*positive & negative condition*/
			...
			if (bMatched)
				odm_ConfigBB_AGC_8821C(pDM_Odm, v1, bMaskDWord, v2);
		}
		i = i + 2;
	}
}
...
u4Byte
ODM_GetVersion_TC_8821C_AGC_TAB(void)
{
	   return 9;
}
...
)
{
	...
	u1Byte     cCond;
	BOOLEAN bMatched = TRUE, bSkipped = FALSE;
	u4Byte     ArrayLen    = sizeof(Array_TC_8821C_PHY_REG)/sizeof(u4Byte);
	pu4Byte    Array       = Array_TC_8821C_PHY_REG;
	
	u4Byte	v1 = 0, v2 = 0, pre_v1 = 0, pre_v2 = 0;

	ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> ODM_ReadAndConfig_TC_8821C_PHY_REG\n"));
	...
	while ((i + 1) < ArrayLen) {
		...
		if (v1 & (BIT31 | BIT30)) {/*positive & negative condition*/
			...
			if (bMatched)
				odm_ConfigBB_PHY_8821C(pDM_Odm, v1, bMaskDWord, v2);
		}
		i = i + 2;
	}
}
...
u4Byte
ODM_GetVersion_TC_8821C_PHY_REG(void)
{
	   return 9;
}
...
u4Byte Array_TC_8821C_PHY_REG_PG[] = { 
...
{
	u4Byte     i         = 0;
	u4Byte     ArrayLen    = sizeof(Array_TC_8821C_PHY_REG_PG)/sizeof(u4Byte);
	pu4Byte    Array       = Array_TC_8821C_PHY_REG_PG;
	...
	ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> ODM_ReadAndConfig_TC_8821C_PHY_REG_PG\n"));
	...
	for (i = 0; i < ArrayLen; i += 6) {
	    ...
	    odm_ConfigBB_PHY_REG_PG_8821C(pDM_Odm, v1, v2, v3, v4, v5, v6);
