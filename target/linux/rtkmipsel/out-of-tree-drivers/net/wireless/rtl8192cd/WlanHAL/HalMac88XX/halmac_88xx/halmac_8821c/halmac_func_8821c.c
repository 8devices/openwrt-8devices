	...
	if (HALMAC_INTERFACE_USB == pHalmac_adapter->halmac_interface) {
		if (pHalmac_adapter->halmac_bulkout_num == 2) {
			...
			case HALMAC_TRX_MODE_DELAY_LOOPBACK:
				...
				break;
			default:
				PLATFORM_MSG_PRINT(pDriver_adapter, HALMAC_MSG_INIT, HALMAC_DBG_ERR, "halmac_init_trx_cfg_8821C 0 switch case not support\n");
			...
			case HALMAC_TRX_MODE_DELAY_LOOPBACK:
				...
				break;
			default:
				PLATFORM_MSG_PRINT(pDriver_adapter, HALMAC_MSG_INIT, HALMAC_DBG_ERR, "halmac_init_trx_cfg_8821C 1 switch case not support\n");
				return HALMAC_RET_TRX_MODE_NOT_SUPPORT;
			}
		}
	} else {
		...
		case HALMAC_TRX_MODE_DELAY_LOOPBACK:
			...
			break;
		default:
			PLATFORM_MSG_PRINT(pDriver_adapter, HALMAC_MSG_INIT, HALMAC_DBG_ERR, "halmac_init_trx_cfg_8821C 2 switch case not support\n");
			return HALMAC_RET_TRX_MODE_NOT_SUPPORT;
		}
	}
...
)
{
	...
	if (HALMAC_LA_MODE_DISABLE == pHalmac_adapter->txff_allocation.la_mode) {
		/* pHalmac_adapter->txff_allocation.tx_fifo_pg_num = HALMAC_TX_FIFO_SIZE_8821C / HALMAC_TX_PAGE_SIZE_8821C; */
		pHalmac_adapter->txff_allocation.tx_fifo_pg_num = HALMAC_TX_FIFO_SIZE_8821C >> HALMAC_TX_PAGE_SIZE_2_POWER_8821C;
	} else if (HALMAC_LA_MODE_PARTIAL == pHalmac_adapter->txff_allocation.la_mode) {
		/* pHalmac_adapter->txff_allocation.tx_fifo_pg_num = HALMAC_TX_FIFO_SIZE_LA_8821C / HALMAC_TX_PAGE_SIZE_8821C; */
		pHalmac_adapter->txff_allocation.tx_fifo_pg_num = HALMAC_TX_FIFO_SIZE_LA_8821C >> HALMAC_TX_PAGE_SIZE_2_POWER_8821C;
	} else if (HALMAC_LA_MODE_FULL == pHalmac_adapter->txff_allocation.la_mode) {
		rx_f_ifo_boundary = HALMAC_RX_FIFO_SIZE_8821C - HALMAC_WOWLAN_PATTERN_SIZE_8821C - 1;
		...
		PLATFORM_MSG_PRINT(pDriver_adapter, HALMAC_MSG_INIT, HALMAC_DBG_ERR, "la_mode parameter undefine, disable it\n");
		/* pHalmac_adapter->txff_allocation.tx_fifo_pg_num = HALMAC_TX_FIFO_SIZE_8821C / HALMAC_TX_PAGE_SIZE_8821C; */
		pHalmac_adapter->txff_allocation.tx_fifo_pg_num = HALMAC_TX_FIFO_SIZE_8821C >> HALMAC_TX_PAGE_SIZE_2_POWER_8821C;
	}
	...
	switch (halmac_trx_mode) {
	case HALMAC_TRX_MODE_NORMAL:
		HPQ_num = HALMAC_NORMAL_HPQ_PGNUM_8821C;
		LPQ_Nnum = HALMAC_NORMAL_LPQ_PGNUM_8821C;
		NPQ_num = HALMAC_NORMAL_NPQ_PGNUM_8821C;
		EXPQ_num = HALMAC_NORMAL_EXPQ_PGNUM_8821C;
		GAPQ_num = HALMAC_NORMAL_GAP_PGNUM_8821C;
	...
	case HALMAC_TRX_MODE_TRXSHARE:
		break;
	case HALMAC_TRX_MODE_WMM:
		HPQ_num = HALMAC_WMM_HPQ_PGNUM_8821C;
		LPQ_Nnum = HALMAC_WMM_LPQ_PGNUM_8821C;
		NPQ_num = HALMAC_WMM_NPQ_PGNUM_8821C;
		EXPQ_num = HALMAC_WMM_EXPQ_PGNUM_8821C;
		GAPQ_num = HALMAC_WMM_GAP_PGNUM_8821C;
		PUBQ_num = pHalmac_adapter->txff_allocation.ac_q_pg_num - HPQ_num - LPQ_Nnum - NPQ_num - EXPQ_num - GAPQ_num;
		rx_f_ifo_boundary = HALMAC_RX_FIFO_SIZE_8821C - HALMAC_WOWLAN_PATTERN_SIZE_8821C - 1;
		transfer_mode = HALMAC_TRNSFER_NORMAL;
		break;
	...
	case HALMAC_TRX_MODE_LOOPBACK:
	case HALMAC_TRX_MODE_DELAY_LOOPBACK:
		HPQ_num = HALMAC_LB_HPQ_PGNUM_8821C;
		LPQ_Nnum = HALMAC_LB_LPQ_PGNUM_8821C;
		NPQ_num = HALMAC_LB_NPQ_PGNUM_8821C;
		EXPQ_num = HALMAC_LB_EXPQ_PGNUM_8821C;
		GAPQ_num = HALMAC_LB_GAP_PGNUM_8821C;
		PUBQ_num = pHalmac_adapter->txff_allocation.ac_q_pg_num - HPQ_num - LPQ_Nnum - NPQ_num - EXPQ_num - GAPQ_num;
		rx_f_ifo_boundary = HALMAC_RX_FIFO_SIZE_8821C - 1;
	...
	if (HALMAC_INTERFACE_USB == pHalmac_adapter->halmac_interface) {
		if (pHalmac_adapter->halmac_bulkout_num == 2) {
			...
			switch (halmac_trx_mode) {
			case HALMAC_TRX_MODE_NORMAL:
				HPQ_num = HALMAC_NORMAL_2BULKOUT_HPQ_PGNUM_8821C;
				LPQ_Nnum = HALMAC_NORMAL_2BULKOUT_LPQ_PGNUM_8821C;
				NPQ_num = HALMAC_NORMAL_2BULKOUT_NPQ_PGNUM_8821C;
				EXPQ_num = HALMAC_NORMAL_2BULKOUT_EXPQ_PGNUM_8821C;
				GAPQ_num = HALMAC_NORMAL_2BULKOUT_GAP_PGNUM_8821C;
				PUBQ_num = pHalmac_adapter->txff_allocation.ac_q_pg_num - HPQ_num - LPQ_Nnum - NPQ_num - EXPQ_num - GAPQ_num;
				rx_f_ifo_boundary = HALMAC_RX_FIFO_SIZE_8821C - HALMAC_WOWLAN_PATTERN_SIZE_8821C - 1;
				transfer_mode = HALMAC_TRNSFER_NORMAL;
				break;
			...
			case HALMAC_TRX_MODE_LOOPBACK:
			case HALMAC_TRX_MODE_DELAY_LOOPBACK:
				HPQ_num = HALMAC_LB_2BULKOUT_HPQ_PGNUM_8821C;
				LPQ_Nnum = HALMAC_LB_2BULKOUT_LPQ_PGNUM_8821C;
				NPQ_num = HALMAC_LB_2BULKOUT_NPQ_PGNUM_8821C;
				EXPQ_num = HALMAC_LB_2BULKOUT_EXPQ_PGNUM_8821C;
				GAPQ_num = HALMAC_LB_2BULKOUT_GAP_PGNUM_8821C;
				PUBQ_num = pHalmac_adapter->txff_allocation.ac_q_pg_num - HPQ_num - LPQ_Nnum - NPQ_num - EXPQ_num - GAPQ_num;
				rx_f_ifo_boundary = HALMAC_RX_FIFO_SIZE_8821C - 1;
				transfer_mode = HALMAC_TRNSFER_LOOPBACK_DIRECT;
				HALMAC_REG_WRITE_16(pHalmac_adapter, REG_WMAC_LBK_BUF_HD_V1, (u16)pHalmac_adapter->txff_allocation.rsvd_pg_bndy);
			...
			switch (halmac_trx_mode) {
			case HALMAC_TRX_MODE_NORMAL:
				HPQ_num = HALMAC_NORMAL_3BULKOUT_HPQ_PGNUM_8821C;
				LPQ_Nnum = HALMAC_NORMAL_3BULKOUT_LPQ_PGNUM_8821C;
				NPQ_num = HALMAC_NORMAL_3BULKOUT_NPQ_PGNUM_8821C;
				EXPQ_num = HALMAC_NORMAL_3BULKOUT_EXPQ_PGNUM_8821C;
				GAPQ_num = HALMAC_NORMAL_3BULKOUT_GAP_PGNUM_8821C;
				PUBQ_num = pHalmac_adapter->txff_allocation.ac_q_pg_num - HPQ_num - LPQ_Nnum - NPQ_num - EXPQ_num - GAPQ_num;
				rx_f_ifo_boundary = HALMAC_RX_FIFO_SIZE_8821C - HALMAC_WOWLAN_PATTERN_SIZE_8821C - 1;
				transfer_mode = HALMAC_TRNSFER_NORMAL;
				break;
			...
			case HALMAC_TRX_MODE_LOOPBACK:
			case HALMAC_TRX_MODE_DELAY_LOOPBACK:
				HPQ_num = HALMAC_LB_3BULKOUT_HPQ_PGNUM_8821C;
				LPQ_Nnum = HALMAC_LB_3BULKOUT_LPQ_PGNUM_8821C;
				NPQ_num = HALMAC_LB_3BULKOUT_NPQ_PGNUM_8821C;
				EXPQ_num = HALMAC_LB_3BULKOUT_EXPQ_PGNUM_8821C;
				GAPQ_num = HALMAC_LB_3BULKOUT_GAP_PGNUM_8821C;
				PUBQ_num = pHalmac_adapter->txff_allocation.ac_q_pg_num - HPQ_num - LPQ_Nnum - NPQ_num - EXPQ_num - GAPQ_num;
				rx_f_ifo_boundary = HALMAC_RX_FIFO_SIZE_8821C - 1;
				transfer_mode = HALMAC_TRNSFER_LOOPBACK_DIRECT;
				HALMAC_REG_WRITE_16(pHalmac_adapter, REG_WMAC_LBK_BUF_HD_V1, (u16)pHalmac_adapter->txff_allocation.rsvd_pg_bndy);
